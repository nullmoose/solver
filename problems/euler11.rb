...
line1 =  [ 8, 02, 22, 97, 38, 15,  0, 40,  0, 75,  4,  5,  7, 78, 52, 12, 50, 77, 91,  8]
...
def checkprod(start, dir, g)
  
  p = g[start[0]][start[1]]
  
  if start[0] + (dir[0]*3) > 19 || start[0] + (dir[0]*3) < 0 || start[1] + (dir[1]*3) > 19 || start[1] + (dir[1]*3) < 0
    return 0
  end
...
grid.push(line1,  line2,  line3,  line4,  line5,  line6,  line7,  line8,  line9,  line10, line11, line12, line13, line14, line15, line16, line17, line18, line19, line20)
